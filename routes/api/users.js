...
router.post(
  ...
  validate(joiAuthSchemas.userSchemaRegisterJoi),
  controllerRegister
);
// login
router.post(
  "/login",
  validate(joiAuthSchemas.userSchemaLoginJoi),
  controllerLogin
);
// logout
...
router.patch(
  "/subscribe",
  authentication,
  validate(joiAuthSchemas.userSchemaSubscriptionJoi),
  controllerUpdateSubscription
);
// avatar
router.patch(
...
router.post(
  "/verify",
  validate(joiAuthSchemas.userEmailVerificationJoi),
  controllerResendVerifyEmail
);
